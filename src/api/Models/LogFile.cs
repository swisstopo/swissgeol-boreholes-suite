...
public class LogFile : IIdentifyable, IChangeTracking
{
    ...
    /// <summary>
    /// Gets the <see cref="Codelist"/>s with schema name 'pass_type' used by the <see cref="LogFile"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="Codelist"/>s with schema name 'data_package' used by the <see cref="LogFile"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="Codelist"/>s with schema name 'depth_type' used by the <see cref="LogFile"/>.
    /// </summary>
    public Codelist? DepthType { get; set; }

    /// <summary>
    /// Gets or sets the codelist ids with schema name 'tool_type' of the <see cref="LogFile"/>'s many to many codelist relations.
    /// </summary>
    [NotMapped]
    [IncludeInExport]
    ...
    /// <summary>
    /// Gets the <see cref="Codelist"/>s with schema name 'tool_type' used by the <see cref="LogFile"/>.
    /// </summary>
