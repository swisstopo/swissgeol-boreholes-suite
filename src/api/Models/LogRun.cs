...
public class LogRun : IIdentifyable, IChangeTracking
{
    ...
    /// <summary>
    /// Gets the <see cref="Codelist"/>s with schema name 'conveyance_method' used by the <see cref="LogRun"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="Codelist"/>s with schema name 'borehole_status' used by the <see cref="LogRun"/>.
    /// </summary>
