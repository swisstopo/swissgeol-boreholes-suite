...
/// <summary>
/// Join table entity for a <see cref="Models.Codelist"/> with the schemaName 'structure_syn_gen' attached to a <see cref="Models.LithologyDescription"/>.
/// </summary>
[Table("lithology_description_structure_syn_gen_codelist")]
public class LithologyDescriptionStructureSynGenCodes : ILithologyDescriptionCode
{
    /// <inheritdoc/>
