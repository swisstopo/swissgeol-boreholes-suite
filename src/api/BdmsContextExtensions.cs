...
public static class BdmsContextExtensions
{
    ...
    public static void SeedData(this BdmsContext context)
    {
        ...
        // Seed stratigraphy
        var stratigraphy_ids = 21_000_000;
        ...
        var fakeStratigraphies = new Faker<Stratigraphy>()
            ...
            .RuleFor(o => o.UpdatedBy, _ => default!)
            .RuleFor(o => o.Layers, [])
            .RuleFor(o => o.Lithologies, [])
            .RuleFor(o => o.LithologicalDescriptions, [])
            .RuleFor(o => o.FaciesDescriptions, [])
            .RuleFor(o => o.Chronostratigraphies, [])
            .RuleFor(o => o.Lithostratigraphies, []);
        ...
        // TODO: Update join table seeding for lithology
        ...
        var lithologicalDescription_ids = 23_600_000;
        var fakelithologicalDescriptions = new Faker<LithologicalDescription>()
            ...
            .RuleFor(o => o.StratigraphyId, f => GetStratigraphyId(lithologicalDescription_ids, 23_600_000))
            .RuleFor(o => o.Stratigraphy, _ => default!)
        ...
        var faciesDescription_ids = 23_700_000;
        var fakeFaciesDescriptions = new Faker<FaciesDescription>()
            ...
            .RuleFor(o => o.StratigraphyId, f => GetStratigraphyId(faciesDescription_ids, 23_700_000))
            .RuleFor(o => o.Stratigraphy, _ => default!)
        ...
        context.Database.ExecuteSqlInterpolated($"SELECT setval(pg_get_serial_sequence('bdms.chronostratigraphy', 'id_chr'), {chronostratigraphy_ids - 1})");
