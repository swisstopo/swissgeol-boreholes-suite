...
public static class BdmsContextExtensions
{
    ...
    public static void SeedData(this BdmsContext context)
    {
        ...
        var fakeLithologyDescriptions = new Faker<LithologyDescription>()
            ...
            .RuleFor(o => o.GrainAngularityCodelists, _ => new Collection<Codelist>())
            .RuleFor(o => o.LithologyUnconDebrisCodeCodelistIds, (f, ld) => ld.Lithology.IsUnconsolidated ? f.PickRandom(lithologyConIds, f.Random.Int(0, 2)).ToList() : new List<int>())
            .RuleFor(o => o.LithologyUnconDebrisCodeCodelists, _ => new Collection<Codelist>())
