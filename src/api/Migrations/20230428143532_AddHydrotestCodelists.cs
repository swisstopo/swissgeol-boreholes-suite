...
public partial class AddHydrotestCodelists : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(@"INSERT INTO bdms.codelist(
                                ...
                                (15203172, 003, 'htest101', '', 'Pump-/Injektionsversuch, variable Rate', '', '', '', '', '', '', '', 3, NULL, False, ''),
                                (15203173, 004, 'htest101', '', 'Pump-/Injektionsversuch, konstante Druckhöhe', '', '', '', '', '', '', '', 4, NULL, False, ''),
                                (15203174, 005, 'htest101', '', 'schlagartige Änderung der Druckhöhe (Slug/Bail, Pulse)', '', '', '', '', '', '', '', 5, NULL, False, ''),
                                (15203175, 006, 'htest101', '', 'Druckerholung im offenen Bohrloch/Gestänge/Piezometer', '', '', '', '', '', '', '', 6, NULL, False, ''),
                                (15203176, 007, 'htest101', '', 'Druckerholung im geschlossenen Interval', '', '', '', '', '', '', '', 7, NULL, False, ''),
                                (15203177, 008, 'htest101', '', 'Wasserdruckversuch (Drillstem, Lugeon)', '', '', '', '', '', '', '', 8, NULL, False, ''),
                                (15203178, 009, 'htest101', '', 'Flowmeter- / Fluid-Logging-Versuch', '', '', '', '', '', '', '', 9, NULL, False, ''),
                                (15203179, 010, 'htest101', '', 'Infiltrationsversuch, ungesättigte Zone', '', '', '', '', '', '', '', 10, NULL, False, ''),
                                (15203180, 011, 'htest101', '', 'Kornverteilungsanalyse', '', '', '', '', '', '', '', 11, NULL, False, ''),
                                ...
                                (15203188, 003, 'htest102', '', 'keine Angaben', '', '', '', '', '', '', '', 3, NULL, False, ''),
                                (15203189, 001, 'htest103', '', 'stationär', '', '', '', '', '', '', '', 1, NULL, False, ''),
                                (15203190, 002, 'htest103', '', 'instationär', '', '', '', '', '', '', '', 2, NULL, False, ''),
                                (15203191, 003, 'htest103', '', 'numerisch', '', '', '', '', '', '', '', 3, NULL, False, ''),
                                (15203192, 004, 'htest103', '', 'unbekannt', '', '', '', '', '', '', '', 4, NULL, False, ''),
                                (15203193, 005, 'htest103', '', 'keine Angaben', '', '', '', '', '', '', '', 5, NULL, False, ''),
                                ...
                                (15203201, 008, 'htestres101', '', 'relevante Mächtigkeit', '', '', '', '', '', '', '', 8, NULL, False, ''),
                                (15203202, 009, 'htestres101', '', 'keine Angaben', '', '', '', '', '', '', '', 9, NULL, False, '');");
    }
