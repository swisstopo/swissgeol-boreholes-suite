...
public class UserController : ControllerBase
{
    ...
    private readonly UserSettingsResetService userSettingsResetService;
    ...
    /// <param name="userSettingsResetService">The service for resetting admin settings to initial state.</param>
    public UserController(BdmsContext context, ILogger<UserController> logger, IBoreholePermissionService boreholePermissionService, UserSettingsResetService userSettingsResetService)
    {
        this.context = context;
        this.logger = logger;
        this.boreholePermissionService = boreholePermissionService;
        this.userSettingsResetService = userSettingsResetService;
    }
