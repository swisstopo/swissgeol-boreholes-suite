 ...
 */
export const saveWithSaveBar = (parent?: string) => {
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const saveForm = (parent?: string) => {
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const discardChanges = (parent?: string) => {
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const startEditing = (parent?: string) => {
...
export const startEditingIfInactive = (parent?: string) => {
  const selector = createBaseSelector(parent) + '[data-cy="edit-button"]';
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const stopEditing = (parent?: string) => {
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const cancelEditing = (parent?: string) => {
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const deleteItem = (parent?: string) => {
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const exportItem = (parent?: string) => {
 ...
 */
const exportFileType = (fileType: string) => {
 ...
 * @param {string} parent (optional) The parent of the button.
 */
export const copyItem = (parent?: string) => {
 ...
 */
export const addItem = (itemLabel: string) => {
  cy.get(".MuiCircularProgress-root").should("not.exist");
