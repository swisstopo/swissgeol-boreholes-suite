...
import { checkRowWithIndex, verifyRowContains, verifyTableLength } from "../helpers/dataGridHelpers";
import { setInput, setSelect } from "../helpers/formHelpers";
import { BoreholeTab, navigateInBorehole, navigateInSidebar, SidebarMenuItem } from "../helpers/navigationHelpers";
import {
...
} from "../helpers/swissgeolCoreHelpers";
import {
  createBorehole,
