...
Weitere rechtliche Bestimmungen finden Sie hier: https://www.swissgeol.ch/de/impressum
`;
...
Further legal provisions can be found here: https://www.swissgeol.ch/en/impressum
`;
...
Pour plus d'informations légales, veuillez consulter le lien suivant: https://www.swissgeol.ch/fr/impressum
`;
...
Per ulteriori informazioni legali, consultare il seguente link: https://www.swissgeol.ch/it/impressum
`;
