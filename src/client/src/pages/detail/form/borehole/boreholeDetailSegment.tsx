...
import { FormBooleanSelect, FormContainer, FormDomainSelect, FormInput } from "../../../../components/form/form.ts";
import FormInputDisplayOnly from "../../../../components/form/formInputDisplayOnly.tsx";
...
const BoreholeDetailSegment = ({ formMethods, borehole, editingEnabled }: BoreholeDetailProps) => {
    ...
    <>
      ...
      <FormContainer direction="row">
        <FormInput
          ...
          readonly={!editingEnabled}
        />
        <FormInputDisplayOnly label={"top_bedrock_fresh_tvd"} value={topBedrockFreshTVD} withThousandSeparator={true} />
      </FormContainer>
      <FormContainer direction="row">
        <FormInput
