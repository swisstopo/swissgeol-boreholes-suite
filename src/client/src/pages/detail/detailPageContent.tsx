        ...
        <Box
          ...
          <Switch>
            ...
            <Route
              ...
              render={() => <WaterIngress isEditable={editingEnabled} boreholeId={id} />}
            />
            <Route
              exact
              path={"/:id/hydrogeology/groundwaterlevelmeasurement"}
              render={() => <GroundwaterLevelMeasurement isEditable={editingEnabled} boreholeId={id} />}
            />
            <Route
              exact
              path={"/:id/hydrogeology/fieldmeasurement"}
              render={() => <FieldMeasurement isEditable={editingEnabled} boreholeId={id} />}
            />
            <Route
              exact
              path={"/:id/hydrogeology/hydrotest"}
              render={() => <Hydrotest isEditable={editingEnabled} boreholeId={id} />}
            />
            <Route
            ...
            <Route exact path={"/:id/status"} render={() => <WorkflowForm id={id} />} />
            <Route
              path={"/:id"}
              render={() => {
                return (
