        ...
        <Table.Body>
          {layers.map((item, idx) => {
            ...
            if (_.isFunction(this.props.onResolve)) {
              if (consistency.hasOwnProperty(item.id)) {
                if (consistency[item.id].missingLayers === true) {
                  ret.push(
                    <Table.Row
                      active={false}
                      disabled
                      ...
                      <Table.Cell
                        ...
                        <div
                          ...
                          &nbsp;
                          <TranslationText id="errorMissingLayerSolution" />
                        </div>
                      </Table.Cell>
                    </Table.Row>,
                  );
                  ...
                  ret.push(
                    <Table.Row
                        ...
                        {resolving === true ? (
                          <div>
                            ...
                            <div
                              ...
                              <Form>
                                {consistency[item.id].errorGap === true ||
                                consistency[item.id].errorStartWrong ===
                                  true ? (
                                  <Form.Field>
                                    <Radio
                      ...
                      this.props.borehole.data.role !== "EDIT" ? null : this
            ...
            if (
              ...
              ret.push(
                <Table.Row
                  ...
                  <Table.Cell
                    collapsing
                    colSpan={_.isFunction(this.props.onDelete) ? "3" : "2"}>
                    <div
                      style={{
                        fontWeight: "bold",
                      }}>
                      <TranslationText id="errorAttention" />
                    </div>
                    <div
                      style={{
                        fontSize: "0.8em",
                    ...
                    <div
                      ...
                      <Button
                        ...
                        onClick={e => {
                          ...
                          const value =
                            _.isNil(this.state.value) === false
                          ...
                          this.setState(
                            ...
                            () => {
                              this.props.onDelete(item, deleteAction, value);
                            },
                          );
                        }}
                        size="mini">
            ...
            if (consistency.missingBedrock === true) {
              ...
              ret.push(
                <Table.Row
                    ...
                    {resolving === true ? (
                      <div>
                        ...
                        <div
                          ...
                          <TranslationText id="errorMissingBedrockSolution" />
                        </div>
                        <div
                          style={{
                            marginTop: "0.5em",
                  ...
                  this.props.borehole.data.lock.username !==
                    this.props.user.data.username ||
                  this.props.borehole.data.role !==
                    "EDIT" ? null : resolving === false ? (
                    <Table.Cell collapsing>
                      <Button
                        basic
                        icon
                ...
                <Table.Row
                  ...
                  <Table.Cell
                    ...
                    <div
                      ...
                      <Icon name="warning sign" />
                      &nbsp;
                      <TranslationText id="errorWrongDepth" />
                    </div>
                    {resolving === true ? (
                      <div>
                        <div
                          ...
                          <TranslationText
                            extra={{
                              lDepth: _.isNil(
                                layers[layers.length - 1].depth_to,
                              )
                                ? "n/a"
                                : layers[layers.length - 1].depth_to,
                              bDepth: _.isNil(borehole.data.length)
                                ? "n/a"
                                : borehole.data.length + "m",
                            }}
                            id="errorWrongDepth"
                          />
                        </div>
