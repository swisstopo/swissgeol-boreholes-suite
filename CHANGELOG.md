...
- Added a new maintenance task to merge duplicate users that share the same email address by reassigning all data from older duplicates to the newest user.
