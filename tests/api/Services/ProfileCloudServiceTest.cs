...
public class ProfileCloudServiceTest
{
    ...
    public void TestInitialize()
    {
        ...
        profileCloudService = new ProfileCloudService(context, configuration, loggerMock.Object, contextAccessorMock.Object, s3ClientMock, Mock.Of<IServiceScopeFactory>());
    ...
    public async Task UploadProfileFailsWhenS3UploadThrowsAndDoesNotCreateProfileRow()
    {
        ...
        var failingService = new ProfileCloudService(context, configuration, loggerMock.Object, contextAccessorMock.Object, failingS3Mock.Object, Mock.Of<IServiceScopeFactory>());
