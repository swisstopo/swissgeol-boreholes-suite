...
public class CodeListControllerTest
{
    ...
    public async Task GetAllEntriesAsync()
    {
        ...
        Assert.AreEqual(4042, codeLists.Count());
    }
    ...
    public async Task GetEntriesBySchema()
    {
        ...
        var codeListToTest = codeLists.Single(c => c.Id == 100002926);
        Assert.AreEqual(100002926, codeListToTest.Id);
    ...
    public async Task GetCsvExport()
    {
        ...
        Assert.AreEqual(4044, response.Content.Split('\n').Length);
    }
}
