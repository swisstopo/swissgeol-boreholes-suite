...
public class ImportControllerTest
{
    ...
    public async Task UploadShouldSavePrecisionDatasetAsync()
    {
        ...
        Assert.AreEqual((int)ReferenceSystem.LV95, boreholeLV95.OriginalReferenceSystemId);
        ...
        Assert.AreEqual((int)ReferenceSystem.LV03, boreholeLV03.OriginalReferenceSystemId);
        ...
        Assert.AreEqual((int)ReferenceSystem.LV03, boreholeWithZeros.OriginalReferenceSystemId);
