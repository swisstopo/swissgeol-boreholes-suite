...
public class BoreholeControllerTest
{
    ...
    public async Task Copy()
    {
        ...
        Assert.AreEqual("Darrion Quitzon (Copy)", copiedBorehole.OriginalName);
        ...
        Assert.AreEqual("Research cross-media", copiedBorehole.Stratigraphies.First().Layers.First().Casing);
